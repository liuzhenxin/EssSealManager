...
<div class="mian_4">
  <form id="form1" name="form1" method="post" action="addRegSeal.jsp">

    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#666666">
      <tbody>
        <tr>
          <td height="100" background="images/bg_list.gif"><div style="padding-left:10px; font-weight:bold; color:#FFFFFF">增加新印章</div></td>
        </tr>
        <tr>
          <td bgcolor="#FFFFFF"><table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
              <tbody>
                ...
                <tr onmouseover="style.backgroundColor='#EEEEEE'" onmouseout="style.backgroundColor='#FFFFFF'" bgcolor="#FFFFFF">
                  ...
                  <td><input name="sealName" type="text" size="100" readonly="readonly" /></td>
                </tr>
                <tr onmouseover="style.backgroundColor='#EEEEEE'" onmouseout="style.backgroundColor='#FFFFFF'" bgcolor="#FFFFFF">
                ...
                <tr onmouseover="style.backgroundColor='#EEEEEE'" onmouseout="style.backgroundColor='#FFFFFF'" bgcolor="#FFFFFF">
                  ...
                  <td><input name="cltName" type="text" size="100" readonly="readonly" /></td>
                </tr>  
                <tr onmouseover="style.backgroundColor='#EEEEEE'" onmouseout="style.backgroundColor='#FFFFFF'" bgcolor="#FFFFFF">
                  <td height="25" width="34%">特征文件信息：</td>
                  <td><input name="sealPath" type="text" size="100" readonly="readonly" /></td>
                </tr>       
               	<tr onmouseover="style.backgroundColor='#EEEEEE'" onmouseout="style.backgroundColor='#FFFFFF'" bgcolor="#FFFFFF">
                  <td height="25" width="34%">到期时间：</td>
                  <td><input name="endTime" type="text" size="100" readonly="readonly" /></td>
                </tr>        
                 <tr onmouseover="style.backgroundColor='#EEEEEE'" onmouseout="style.backgroundColor='#FFFFFF'" bgcolor="#FFFFFF">
                  <td width="34%" height="13">印章授权：</td>
                  <td><input name="sealAuth" type="text" size="100" readonly="readonly" /></td>
                </tr>    
                 <tr onmouseover="style.backgroundColor='#EEEEEE'" onmouseout="style.backgroundColor='#FFFFFF'" bgcolor="#FFFFFF">
                  <td width="34%" height="13">印章认证信息：</td>
                <td><input name="keyWords" type="text" size="100" readonly="readonly" /></td>
                </tr>                          
                <tr onmouseover="style.backgroundColor='#EEEEEE'" onmouseout="style.backgroundColor='#FFFFFF'" bgcolor="#FFFFFF">
                  <td height="25">&nbsp;</td>
                ...
                <td><a href="ESS网络版制章控件.zip">点击此处下载控件，安装前，请关闭打开的所有IE浏览器</a></td>
                </tr>
              </tbody>
            </table></td>
        </tr>
